          ...
          <FrontSide className="frontSide">
            <span>
              ...
              <div className="sportArea">
                ...
                {this.props.chosenOption.filter((team) => team.league === 'MLB')
                  .length < 1 ? (
                    <h5>No Baseball Teams</h5>
                  ) : (
              ...
              <div className="sportArea">
                ...
                {this.props.chosenOption.filter(
                  (team) => team.league === 'NBA' || team.league === 'WNBA',
                ).length < 1 ? (
                  <h5>No Basketball Teams</h5>
                  ) : (
                    this.props.chosenOption.map((team) => {
              ...
              <div className="sportArea">
                ...
                {this.props.chosenOption.filter((team) => team.league === 'NFL')
                  .length < 1 ? (
                    <h5>No Football Teams</h5>
                  ) : (
                    this.props.chosenOption.map((team) => {
                      if (team.league === 'NFL') {
                        return (
              ...
              <div className="sportArea">
                ...
                {this.props.chosenOption.filter((team) => team.league === 'NHL')
                  .length < 1 ? (
                    <h5>No Hockey Teams</h5>
                  ) : (
                    this.props.chosenOption.map((team) => {
                      if (team.league === 'NHL') {
                        return (
              ...
              <div className="sportArea">
                ...
                {this.props.chosenOption.filter((team) => team.league === 'MLS')
                  .length < 1 ? (
                    <h5>No Soccer Teams</h5>
                  ) : (
                    this.props.chosenOption.map((team) => {
                      if (team.league === 'MLS') {
                        return (
