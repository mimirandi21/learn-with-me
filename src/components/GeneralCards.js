                ...
                >
                    ...
                    >
                        <span>
                            ...
                            <h2>{this.props.chosenOption.abbr !== "DC" ? `Its area is ${this.props.chosenOption.size.toLocaleString()} sq mi, making it the ${formattedSize} largest state.` : `It is ${this.props.chosenOption.size} sq mi in area.`}</h2>
                            <br/>
                            <h3>Nickname(s):</h3>
                            <ul>{this.props.chosenOption.nickname.length > 1 ? this.props.chosenOption.nickname.map(nickname => <li>{nickname}</li>) : <li>{this.props.chosenOption.nickname}</li>}</ul> 
                            <br/>
                            <h3>Motto:</h3>
                            <h5>{this.props.chosenOption.motto}</h5>
                            <br/>
                            <h3>{this.props.chosenOption.abbr !== "DC" ? 'Largest City' : null}</h3>
                            <h5>{this.props.chosenOption.largestcity}</h5>
                            <br/>
                            <div className="generalImg">
                                <figure className="generalFigure">
                                    <h3>State Flower:</h3>
                                    <img src={this.props.chosenOption.flowerimg} height="300px" alt={this.props.chosenOption.flower} />
                                    <figcaption>{this.props.chosenOption.flower}</figcaption>
                                </figure>
                                <figure className="generalFigure">
                                    <h3>State Bird:</h3>
                                    <img src={this.props.chosenOption.birdimg} height="300px" alt={this.props.chosenOption.bird} />
                                    <figcaption>{this.props.chosenOption.bird}</figcaption>
                                </figure>
                                <figure className="generalFigure">
                                    <h3>State Tree:</h3>
                                    <img src={this.props.chosenOption.treeimg} height="300px" alt={this.props.chosenOption.tree} />
